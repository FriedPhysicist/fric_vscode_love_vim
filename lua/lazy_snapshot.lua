return {
  ...
  { "AstroNvim/astrotheme", lazy = false,version = "^3", optional = true },
  ...
  { "nvim-tree/nvim-web-devicons", lazy = false, commit = "cdbcca210cf3655aa9b31ebf2422763ecd85ee5c", optional = true },
