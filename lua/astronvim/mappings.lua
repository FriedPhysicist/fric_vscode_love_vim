...
maps.n["<C-z>"] = { "v:count == 0 ? 'gj' : 'j'", expr = true, desc = "Move cursor down" }
...
-- Navigate tabs
maps.n["gt"] = { function() vim.cmd.tabnext() end, desc = "Next tab" }
maps.n["gT"] = { function() vim.cmd.tabprevious() end, desc = "Previous tab" }
